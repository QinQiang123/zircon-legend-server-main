...
namespace Server.Envir
{
    ...
    public class Config
    {
        ...
        public static bool AdminOnlyLogin { get; set; }  // 仅限管理员登录（普通玩家无法登录）
        ...
        [ConfigSection("Admin")]
        public static bool AdminEnabled { get; set; } = true;
        public static int AdminPort { get; set; } = 7080;
        public static string AdminAllowedIPs { get; set; } = "";
